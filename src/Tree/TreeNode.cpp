...
namespace tree {
    ...
    void TreeNode::accumulateLeafNodes(Queue queue) {
    }
    ...
    int TreeNode::averages() {
    }

    int * TreeNode::collectNodes() {
    }

    bool TreeNode::hasPath(int *path) {
    }
    ...
    int TreeNode::sumOfNodesBetween(int p, int q) {
    }

    int TreeNode::sumOfTree(int X) {
    }
